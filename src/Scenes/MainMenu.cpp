...
{
    _startButton = initButton(ind::PlaceRectangle::getRectangle({ (const irr::s32)x / 4, (const irr::s32)y / 2 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }),
        "./assets/play_game.png");
    _optionsButton = initButton(ind::PlaceRectangle::getRectangle({ (const irr::s32)x * 3 / 4, (const irr::s32)y / 2 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }),
        "./assets/options.png");
    _exitButton = initButton(ind::PlaceRectangle::getRectangle({ (const irr::s32)x / 2, (const irr::s32)y * 3 / 4 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }),
        "./assets/exit.png");
}
...
void ind::MainMenu::resizeButtons(const irr::core::dimension2d<irr::u32>& currSize) const
{
    ...
    _startButton->setRelativePosition(ind::PlaceRectangle::getRectangle({ (const irr::s32)x / 5, (const irr::s32)y / 2 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }));
    _optionsButton->setRelativePosition(ind::PlaceRectangle::getRectangle({ (const irr::s32)x * 4 / 5, (const irr::s32)y / 2 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }));
    _exitButton->setRelativePosition(ind::PlaceRectangle::getRectangle({ (const irr::s32)x / 2, (const irr::s32)y * 4 / 5 }, { (const irr::s32)x / 6, (const irr::s32)y / 14 }));
}
